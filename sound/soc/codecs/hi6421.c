...
#else
    HI6421_PB_VOLTAGE_MAX    = 1400,//1055,/*900*/
#endif
};
...
//    HI6421_SINGLE_BTN_VOLTAGE_MAX = 2480
//    HI6421_SINGLE_BTN_VOLTAGE_MAX = 2600
...
//    0x7F,//0xCC  codec pd 4
    0x7B,//0xCC  codec pd 4, turn on vimd
    0x9E,//0xCD  linein l pga
    0x9E,//0xCE  linein r pga
    0x24,//0xCF  aux pga
//    0x64,//0xD0  main pga, main mic gain = 4DB
    0x76,//0xD0  main pga, main mic gain = 22DB
    0x1E,//0xD1  side pga
...
//    0x28,//0xDB  mixer lineout l pga
    0x24,//0xDB  mixer lineout l pga gain=-15db
    0x00,//0xDC  mixer lineout r
//    0x28,//0xDD  mixer lineout r pga
    0x24,//0xDD  mixer lineout r pga gain=-15db
//    0xC1,//0xDE  headset ctl     HP_CM : 11B : 1.2V
    0x01,//0xDE  headset ctl     HP_CM : 00B : 1.65V
...
{
    int value = hi6421_reg_read(g_codec, HI6421_REG_FREQ_CONFIG);
    value &= ~HI6421_FREQ_AP_MASK;
    ...
    if (HI6421_PORT_MM == substream->pcm->device) {
        if (params_rate(params) > 48000) {
            ...
            value |= HI6421_FREQ_AP_96KHZ;
        } else {
            pr_info("%s : set codec rate 48kHz\n", __FUNCTION__);
            value |= HI6421_FREQ_AP_48KHZ;
        }
        hi6421_reg_write(g_codec, HI6421_REG_FREQ_CONFIG, value);
    }
