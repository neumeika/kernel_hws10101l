...
/* extral dcdc ctrl gpio def*/
#define EXTRAL_DCDC_2V85_EN             (172) // (GPIO_21_4)
#define EXTRAL_DCDC_1V2_EN              (173) //(GPIO_21_5)

/* extral dcdc loadswitch gpio ctrl def*/
#define EXTRAL_DCDC_LOADSWITCH_CAM_VCM        (GPIO_1_1)
#define EXTRAL_DCDC_LOADSWITCH_CAM_AVDD       (GPIO_1_0)
#define EXTRAL_DCDC_LOADSWITCH_SD_EN          (GPIO_17_7)

#define VERSION_1_GPIO GPIO_1_4
#define VERSION_2_GPIO GPIO_1_5

#define VOL_UP		(GPIO_17_1)
#define VOL_DOWN	(GPIO_17_2)

#ifdef CONFIG_BOOST_5V
#define SWITCH_BOOST_5V_GPIO    GPIO_0_6     //GPIO06
#endif

#ifdef CONFIG_FSA880_I2C
#define FSA880_INTR_GPIO         GPIO_3_3     //GPIO27
#define SWITCH_OUT5V_GPIO      GPIO_10_2  //GPIO82
#define SWITCH_AP5V_GPIO        GPIO_18_1  //GPIO145 
#define SWITCH_USB_ID_GPIO    GPIO_2_5     //GPIO21
#define USB_CURRENT_WARNING_GPIO   GPIO_1_3 //GPIO11
#define BALONG_USE_GPIO       GPIO_14_4    //GPIO116
#endif
#define MAX8903_CHARGING_FAT_INTR   (GPIO_6_4)
#define MAX8903_CHARGING_EN      (GPIO_9_2)
#define MAX8903_CHARGING_CTRL0   (GPIO_2_6)
#define MAX8903_CHARGING_CTRL1   (GPIO_2_7)
#define MAX8903_DOK              (GPIO_2_4) //
#define MAX8903_CHG              (GPIO_0_5)

#define MRSENSOR_MRUS51S_IO             (GPIO_15_6)
#define EXTRAL_DYNAMIC_DCDC_EN  (GPIO_2_3)

#define SIM_INT_IO                      (GPIO_3_2)
#define AD7147_INT_GPIO 		(GPIO_18_0)

#if defined(CONFIG_SUPPORT_MICRO_USB_PORT)
#define USB_AP_5V_EN_GPIO GPIO_18_1  //GPIO145
#define MODEM_USB_CTRL_GPIO GPIO_14_4	//wuxinxian
#define USB_CURRENT_WARNING_GPIO   GPIO_1_3 //GPIO11
#define USB_ID_DETECT_GPIO   GPIO_2_5  //GPIO21
#define USB_VBUS_5V_EN_GPIO  GPIO_10_2 //GPIO82
#endif
#endif
