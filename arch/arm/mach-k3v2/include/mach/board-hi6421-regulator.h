...
static struct regulator_consumer_supply ldo15_consumers[] = {
	...
	REGULATOR_SUPPLY("light-vcc", "lightsensor"),
...
static struct regulator_consumer_supply extral_dcdc_2v85_consumers[] = {
      REGULATOR_SUPPLY("dcdc_2v85", "camera"),
      REGULATOR_SUPPLY("dcdc_2v85", "hi_mci.0"),
};

static struct regulator_consumer_supply extral_dcdc_1v2_consumers[] = {
      REGULATOR_SUPPLY("dcdc_1v2", "camera"),
};
...
static struct regulator_init_data extral_dynamic_dcdc_regulator = {
		.constraints = {
			...
			.valid_ops_mask = REGULATOR_CHANGE_VOLTAGE |
			//REGULATOR_CHANGE_STATUS | REGULATOR_CHANGE_MODE,
			REGULATOR_CHANGE_STATUS | REGULATOR_CHANGE_MODE | REGULATOR_CHANGE_DRMS,
			.always_on = 0,
		},
