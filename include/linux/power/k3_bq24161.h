...
/*(-10 *10) battery temperature is -10 degree*/
#define	BQ24161_COLD_BATTERY_THRESHOLD		(-100)
 /*(0 *10) battery temperature is 0 degree*/
#define	BQ24161_COOL_BATTERY_THRESHOLD		(0)
 /*( 50 *10) battery temperature is 50 degree*/
#define	BQ24161_WARM_BATTERY_THRESHOLD		(500)
 /*(3.0V) battery preconditioning voltage is 3.0V*/
#define	BQ24161_PRECONDITIONING_BATVOLT_THRESHOLD		(3000000)
 /*(3.2V) battery startup voltage is 3.0V*/
#define	BQ24161_STARTUP_BATVOLT_THRESHOLD	(3200000)
 /*low temperature charge termination voltage*/
#define	BQ24161_LOW_TEMP_TERM_VOLTAGE		(4000000)
