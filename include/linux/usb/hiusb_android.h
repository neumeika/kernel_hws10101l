...
enum usb_charger_type{
	...
	CHARGER_REMOVED,
#if defined(CONFIG_SUPPORT_MICRO_USB_PORT) 
	CHARGER_TYPE_USB_OTG_LINE,
	CHARGER_USB_OTG_LINE_REMOVED,
	CHARGER_TYPE_MHL_POWER,
	CHARGER_TYPE_MHL_NO_POWER,
	CHARGER_TYPE_MHL_REMOVED,
#endif
};
...
int k3v2_otg_id_status_change(enum usb_port_event);
#if defined(CONFIG_SUPPORT_MICRO_USB_PORT) 
