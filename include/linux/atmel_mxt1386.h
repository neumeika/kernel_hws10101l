...
#define ATMEL_MXT1386_NAME "atmel_mxt1386"
#define ATMEL_MXT1386_NAME_I2C1 "atmel_mxt1386_i2c1"

/* Fixed addresses inside maXTouch device */
#define	ADDR_INFO_BLOCK				0
#define	ADDR_OBJECT_TABLE			7
#define ID_BLOCK_SIZE               7
#define	OBJECT_TABLE_ELEMENT_SIZE	6
#define MAX_NUM (10)

#define CAL_CHIP					(0x1)
#define RESET_CHIP					(0x1)
#define BACKUP_CHIP					(0x55)
