...
/*
 ...
 Application module must provide this function.
*/
extern void AppVbusControl(int powerOn);
...
#define POWER_STATE_NO_MHL          0
#define POWER_STATE_MHL_NO_POWER    1
#define POWER_STATE_MHL_WITH_POWER  2
extern int g_DEVCAP_VAL_BANDWIDTH;
extern int g_MHL_LOGICAL_DEVICE_MAP;
#endif
