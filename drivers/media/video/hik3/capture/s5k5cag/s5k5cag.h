...
//#ARM GO                                                        
   ...
   {0xFFFF, 0x64FF, 0x00, 2},  //p100 //delay 100ms                             
  ...
  {0x0F12, 0x0050, 0x00, 2},  //0028// 40 addition of ADC columns in Y-ave mode (default 244 0x74) ***
    //WRITE #senHal, 0x00, 2_ForceModeType 0001 // Long exposure mode
  ...
  {0x0F12, 0x0040, 0x00, 2},  //#TVAR_ae_BrAve 091222
    // AE mode     , 0x00, 2
  ...
  {0x0F12, 0x067F, 0x00, 2}, 
    //002A   04BA  , 0x00, 2
    //0F12   0001//, 0x00, 20001(50Hz) 0002(60Hz)
    //0F12   0001//, 0x00, 2REG_SF_USER_FlickerQuantChanged
    //=============, 0x00, 2===================================================================================
    // SET GAS     , 0x00, 2
    //=============, 0x00, 2===================================================================================
    // GAS alpha   , 0x00, 2
    // R, Gr, Gb, B, 0x00, 2 per light source
  ...
  {0x0F12, 0x0000, 0x00, 2},  // #ash_bLumaMode //use Beta : 0001 not use Beta : 0000
    // GAS LUT star, 0x00, 2t address // 7000_347C
  ...
  {0x0F12, 0x0180, 0x00, 2},  // #TVAR_ash_AwbAshCord_6_
    ...
    // SET CCM     , 0x00, 2
    //=============, 0x00, 2===================================================================================
    // CCM start ad, 0x00, 2dress // 7000_33A4
  ...
  {0x0F12, 0x01D8, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[0]
  {0x0F12, 0xFFDC, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[1]
  {0x0F12, 0xFFAF, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[2]
  {0x0F12, 0xFE95, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[3]
  {0x0F12, 0x0252, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[4]
  {0x0F12, 0xFE3B, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[5]
  {0x0F12, 0xFFF0, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[6]
  {0x0F12, 0x000C, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[7]
  {0x0F12, 0x01D3, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[8]
  {0x0F12, 0x00D8, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[9]
  {0x0F12, 0x012C, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[10]
  {0x0F12, 0xFF31, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[11]
  {0x0F12, 0x016A, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[12]
  {0x0F12, 0xFF54, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[13]
  {0x0F12, 0x01FD, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[14]
  {0x0F12, 0xFFF3, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[15]
  {0x0F12, 0x01D0, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[16]
  {0x0F12, 0x0171, 0x00, 2},  //#TVAR_wbt_pOutdoorCcm[17]
    //White balance, 0x00, 2
    //AWB Rgain ini, 0x00, 2tial value
    //{0x002A   0E4, 0x00, 24//
    //{0x0F12   05B, 0x00, 20//06CC//053C //awbb_GainsInit[0] R
    //{0x0F12   040, 0x00, 20//0400 //awbb_GainsInit[1] G
    //{0x0F12   05A, 0x00, 20//055C//0600//055C //awbb_GainsInit[2] B
    //AWB offset   , 0x00, 2
    //{0x002A   0E3, 0x00, 26
    //{0x0F12   003, 0x00, 20 //R	0x0030
    //{0x0F12   FFD, 0x00, 20 //B
    //{0x0F12   000, 0x00, 20 //G
    // param_start , 0x00, 2awbb_IndoorGrZones_m_BGrid
  ...
  {0x0F12, 0x0570, 0x00, 2}, //0470 //awbb_MvEq_RBthresh
  {0x002A, 0x0D5C, 0x00, 2}, 
  {0x0F12, 0x7FFF, 0x00, 2}, //0534 //awbb_LowTempRB
  {0x0F12, 0x0050, 0x00, 2},
  
  {0x002A, 0x0D28, 0x00, 2},                         
  {0x0F12, 0x0270, 0x00, 2}, //wp outdoor
  {0x0F12, 0x0240, 0x00, 2},                         
  ...
  {0x0F12, 0x0002, 0x00, 2},  //awbb_GridEnable
    //	parart	awb, 0x00, 2b_GridConst_2
  ...
  {0x0F12, 0x00C3, 0x00, 2},  //awbb_GridCoeff_B_2
    //	parart	awb, 0x00, 2b_GridConst_1
  ...
  {0x0F12, 0x0390, 0x00, 2},  //awbb_GridConst_1[2]
    //	pard	awb, 0x00, 2b_GridConst_1
    //	parart	awb, 0x00, 2b_GridCorr_R
  ...
  {0x0F12, 0x0000, 0x00, 2},  //awbb_GridCorr_R[17]
    //	pard	awb, 0x00, 2b_GridCorr_R
    //	parart	awb, 0x00, 2b_GridCorr_B
...
//#if 1 //fst      , 0x00, 2
  ...
  {0x0F12, 0x0001, 0x00, 2},    // awbb_GnMinMatchToJump                   
    //{0x00C6      , 0x00, 2
    //{0x0F14    //, 0x00, 2 awbb_GnFarPntImmunity                                                              
    //{0x00C8      , 0x00, 2
    //{0x0F19    //, 0x00, 2  awbb_GnCurPntImmunity                                                            
    //{0x0042      , 0x00, 2
    //{0x0F71    //, 0x00, 2awbb_Use_Filters                                                             
  {0x002A, 0x0DCA, 0x00, 2}, 
  {0x0F12, 0x04B0, 0x00, 2},    //awbb_GainsMaxMove                                                                 
    //{0x0040      , 0x00, 2
    //{0x0F01    //, 0x00, 2   awbb_UseGrThrCorr  
    
  //scene detection                                                   
  {0x002A, 0x0DA0, 0x00,  2},                                                    
  {0x0F12, 0x0005, 0x00,  2},  //awbb_OutdoorDetectionZone_ZInfo_m_GridSz        
                                                                   
  {0x002A, 0x0D88, 0x00,  2},                                                    
  {0x0F12, 0x0038, 0x00,  2}, //#awbb_OutdoorDetectionZone_m_BGrid[0]_m_lef      
  {0x0F12, 0x0074, 0x00,  2}, //#awbb_OutdoorDetectionZone_m_BGrid[0]_m_rig      
  {0x0F12, 0xFFF1, 0x00,  2}, //#awbb_OutdoorDetectionZone_m_BGrid[1]_m_lef      
  {0x0F12, 0x00BF, 0x00,  2}, //#awbb_OutdoorDetectionZone_m_BGrid[1]_m_rig      
  {0x0F12, 0xFF9B, 0x00,  2}, //#awbb_OutdoorDetectionZone_m_BGrid[2]_m_lef      
  {0x0F12, 0x00DB, 0x00,  2}, //#awbb_OutdoorDetectionZone_m_BGrid[2]_m_rig      
  {0x0F12, 0xFF56, 0x00,  2}, //#awbb_OutdoorDetectionZone_m_BGrid[3]_m_lef      
  {0x0F12, 0x00F0, 0x00,  2}, //#awbb_OutdoorDetectionZone_m_BGrid[3]_m_rig      
  {0x0F12, 0xFEFF, 0x00,  2}, //#awbb_OutdoorDetectionZone_m_BGrid[4]_m_lef      
  {0x0F12, 0x010F, 0x00,  2}, //#awbb_OutdoorDetectionZone_m_BGrid[4]_m_rig      
  {0x0F12, 0x0E74, 0x00,  2}, //#awbb_OutdoorDetectionZone_ZInfo_m_AbsGridS      
                                                     
  {0x002A, 0x0DA8, 0x00,  2},                                                    
  {0x0F12, 0x14B8, 0x00,  2},  //awbb_OutdoorDetectionZone_ZInfo_m_MaxNBNB       
  {0x002A, 0x0DA4, 0x00,  2},                                                    
  {0x0F12, 0x274E, 0x00,  2},  //awbb_OutdoorDetectionZone_ZInfo_m_NBoffs 
  
  {0x002A, 0x0D4C, 0x00,  2},                                                                                      
  {0x0F12, 0x0187, 0x00,  2}, //0653    // #awbb_GamutWidthThr1                                                    
  {0x0F12, 0x00CF, 0x00,  2}, //02EB   // #awbb_GamutHeightThr1                                                    
  {0x0F12, 0x000D, 0x00,  2}, //002C   // #awbb_GamutWidthThr2                                                     
  {0x0F12, 0x000A, 0x00,  2}, //000B   // #awbb_GamutHeightThr2  
  ...
  // AFITe start , 0x00, 2address // 7000_07C4
  {0x002A, 0x0770, 0x00, 2}, 
  {0x0F12, 0x07C4, 0x00, 2}, 
  {0x0F12, 0x7000, 0x00, 2}, 
  {0x002A, 0x07C4, 0x00, 2}, 
  {0x0F12, 0x0014, 0x00, 2},  //700007C4 //TVAR_afit_pBaseValS[0] // AFIT16_BRIGHTNESS
  ...
  {0x0F12, 0xFFF6, 0x00, 2},  //700007CA //TVAR_afit_pBaseValS[3] // AFIT16_SHARP_BLUR
  {0x0F12, 0x0000, 0x00, 2},  //700007CC //TVAR_afit_pBaseValS[4] // AFIT16_GLAMOUR
  ...
  {0x0F12, 0x0023, 0x00, 2},  //700007F4 //TVAR_afit_pBaseValS[24] //AFIT16_Sharpening_iLowSharpClamp
  {0x0F12, 0x000f, 0x00, 2},  //700007F6 //TVAR_afit_pBaseValS[25] //AFIT16_Sharpening_iHighSharpClamp
  ...
  {0x0F12, 0x0A06, 0x00, 2},  //7000081E //TVAR_afit_pBaseValS[45] //AFIT8_Demosaicing_iNearGrayDesat[7:0],	AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
  {0x0F12, 0x052d, 0x00, 2},  //70000820 //TVAR_afit_pBaseValS[46] //AFIT8_Sharpening_iMSharpen [7:0],   AFIT8_Sharpening_iMShThresh [15:8]
  {0x0F12, 0x0514, 0x00, 2},  //70000822 //TVAR_afit_pBaseValS[47] //AFIT8_Sharpening_iWSharpen [7:0],   AFIT8_Sharpening_iWShThresh [15:8]
  ...
  {0x0F12, 0x3703, 0x00, 2},  //70000834 //TVAR_afit_pBaseValS[56] //AFIT8_YUV422_DENOISE_iYSupport [7:0],   AFIT8_byr_cgras_iShadingPower [15:8]
  {0x0F12, 0x006E, 0x00, 2},  //70000836 //TVAR_afit_pBaseValS[57] //AFIT8_RGBGamma2_iLinearity [7:0],  AFIT8_RGBGamma2_iDarkReduce [15:8]
  {0x0F12, 0x0878, 0x00, 2},  //70000838 //TVAR_afit_pBaseValS[58] //AFIT8_ccm_oscar_iSaturation[7:0],   AFIT8_RGB2YUV_iYOffset [15:8]
  ...
  {0x0F12, 0x5a02, 0x00, 2},  //70000840 //TVAR_afit_pBaseValS[62] //AFIT8_sddd8a_nClustLevel_H [7:0],   AFIT8_sddd8a_DispTH_Low [15:8]
  {0x0F12, 0x875a, 0x00, 2},  //70000842 //TVAR_afit_pBaseValS[63] //AFIT8_sddd8a_DispTH_High [7:0],	 AFIT8_sddd8a_iDenThreshLow [15:8]
  {0x0F12, 0x2887, 0x00, 2},  //70000844 //TVAR_afit_pBaseValS[64] //AFIT8_sddd8a_iDenThreshHigh[7:0],   AFIT8_Demosaicing_iEdgeDesat [15:8]
  ...
  {0x0F12, 0x2d04, 0x00, 2},  //70000850 //TVAR_afit_pBaseValS[70] //AFIT8_Demosaicing_iDemBlurRange[7:0],   AFIT8_Sharpening_iLowSharpPower [15:8]
  {0x0F12, 0x192d, 0x00, 2},  //70000852 //TVAR_afit_pBaseValS[71] //AFIT8_Sharpening_iHighSharpPower[7:0],	AFIT8_Sharpening_iLowShDenoise [15:8]
  {0x0F12, 0x4019, 0x00, 2},  //70000854 //TVAR_afit_pBaseValS[72] //AFIT8_Sharpening_iHighShDenoise [7:0],	AFIT8_Sharpening_iReduceEdgeMinMult [15:8]
  ...
  {0x0F12, 0xFFF8, 0x00, 2},  //7000089A //TVAR_afit_pBaseValS[107] /AFIT16_SHARP_BLUR
  {0x0F12, 0x0000, 0x00, 2},  //7000089C //TVAR_afit_pBaseValS[108] /AFIT16_GLAMOUR
  ...
  {0x0F12, 0x0028, 0x00, 2},  //700008C4 //TVAR_afit_pBaseValS[128] /AFIT16_Sharpening_iLowSharpClamp
  {0x0F12, 0x0010, 0x00, 2},  //700008C6 //TVAR_afit_pBaseValS[129] /AFIT16_Sharpening_iHighSharpClamp
  ...
  {0x0F12, 0x0A06, 0x00, 2},  //700008EE //TVAR_afit_pBaseValS[149] /AFIT8_Demosaicing_iNearGrayDesat[7:0],	AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
  {0x0F12, 0x0632, 0x00, 2},  //700008F0 //TVAR_afit_pBaseValS[150] /AFIT8_Sharpening_iMSharpen [7:0],   AFIT8_Sharpening_iMShThresh [15:8]
  {0x0F12, 0x0514, 0x00, 2},  //700008F2 //TVAR_afit_pBaseValS[151] /AFIT8_Sharpening_iWSharpen [7:0],   AFIT8_Sharpening_iWShThresh [15:8]
  ...
  {0x0F12, 0x4103, 0x00, 2},  //70000904 //TVAR_afit_pBaseValS[160] /AFIT8_YUV422_DENOISE_iYSupport [7:0],   AFIT8_byr_cgras_iShadingPower [15:8]
  {0x0F12, 0x006e, 0x00, 2},  //70000906 //TVAR_afit_pBaseValS[161] /AFIT8_RGBGamma2_iLinearity [7:0],  AFIT8_RGBGamma2_iDarkReduce [15:8]
  {0x0F12, 0x0878, 0x00, 2},  //70000908 //TVAR_afit_pBaseValS[162] /AFIT8_ccm_oscar_iSaturation[7:0],   AFIT8_RGB2YUV_iYOffset [15:8]
  ...
  {0x0F12, 0x4602, 0x00, 2},  //70000910 //TVAR_afit_pBaseValS[166] /AFIT8_sddd8a_nClustLevel_H [7:0],   AFIT8_sddd8a_DispTH_Low [15:8]
  {0x0F12, 0x8046, 0x00, 2},  //70000912 //TVAR_afit_pBaseValS[167] /AFIT8_sddd8a_DispTH_High [7:0],	 AFIT8_sddd8a_iDenThreshLow [15:8]
  {0x0F12, 0x2880, 0x00, 2},  //70000914 //TVAR_afit_pBaseValS[168] /AFIT8_sddd8a_iDenThreshHigh[7:0],   AFIT8_Demosaicing_iEdgeDesat [15:8]
  ...
  {0x0F12, 0x3204, 0x00, 2},  //70000920 //TVAR_afit_pBaseValS[174] /AFIT8_Demosaicing_iDemBlurRange[7:0],   AFIT8_Sharpening_iLowSharpPower [15:8]
  {0x0F12, 0x192d, 0x00, 2},  //70000922 //TVAR_afit_pBaseValS[175] /AFIT8_Sharpening_iHighSharpPower[7:0],	AFIT8_Sharpening_iLowShDenoise [15:8]
  {0x0F12, 0x4019, 0x00, 2},  //70000924 //TVAR_afit_pBaseValS[176] /AFIT8_Sharpening_iHighShDenoise [7:0],	AFIT8_Sharpening_iReduceEdgeMinMult [15:8]
  ...
  {0x0F12, 0x0000, 0x00, 2},  //7000096A //TVAR_afit_pBaseValS[211] /AFIT16_SHARP_BLUR
  {0x0F12, 0x0000, 0x00, 2},  //7000096C //TVAR_afit_pBaseValS[212] /AFIT16_GLAMOUR
  ...
  {0x0F12, 0x0017, 0x00, 2},  //70000996 //TVAR_afit_pBaseValS[233] /AFIT16_Sharpening_iHighSharpClamp
  ...
  {0x0F12, 0x0A04, 0x00, 2},  //700009BE //TVAR_afit_pBaseValS[253] /AFIT8_Demosaicing_iNearGrayDesat[7:0],	AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
  {0x0F12, 0x0837, 0x00, 2},  //700009C0 //TVAR_afit_pBaseValS[254] /AFIT8_Sharpening_iMSharpen [7:0],   AFIT8_Sharpening_iMShThresh [15:8]
  {0x0F12, 0x051e, 0x00, 2},  //700009C2 //TVAR_afit_pBaseValS[255] /AFIT8_Sharpening_iWSharpen [7:0],   AFIT8_Sharpening_iWShThresh [15:8]
  ...
  {0x0F12, 0x3202, 0x00, 2},  //700009E0 //TVAR_afit_pBaseValS[270] /AFIT8_sddd8a_nClustLevel_H [7:0],   AFIT8_sddd8a_DispTH_Low [15:8]
  {0x0F12, 0x5532, 0x00, 2},  //700009E2 //TVAR_afit_pBaseValS[271] /AFIT8_sddd8a_DispTH_High [7:0],	 AFIT8_sddd8a_iDenThreshLow [15:8]
  {0x0F12, 0x2855, 0x00, 2},  //700009E4 //TVAR_afit_pBaseValS[272] /AFIT8_sddd8a_iDenThreshHigh[7:0],   AFIT8_Demosaicing_iEdgeDesat [15:8]
  ...
  {0x0F12, 0x3c04, 0x00, 2},  //700009F0 //TVAR_afit_pBaseValS[278] /AFIT8_Demosaicing_iDemBlurRange[7:0],   AFIT8_Sharpening_iLowSharpPower [15:8]
  {0x0F12, 0x0F32, 0x00, 2},  //700009F2 //TVAR_afit_pBaseValS[279] /AFIT8_Sharpening_iHighSharpPower[7:0],	AFIT8_Sharpening_iLowShDenoise [15:8]
  ...
  {0x0F12, 0x0A03, 0x00, 2},  //70000A8E //TVAR_afit_pBaseValS[357] /AFIT8_Demosaicing_iNearGrayDesat[7:0],	AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
  ...
  {0x0F12, 0x6402, 0x00, 2},  //4602  //// #TVAR_afit_pBaseVals[368]
  ...
  {0x0F12, 0x0A04, 0x00, 2},  //70000B5E //TVAR_afit_pBaseValS[461] /AFIT8_Demosaicing_iNearGrayDesat[7:0],	AFIT8_Demosaicing_iDFD_ReduceCoeff [15:8]
  ...
  {0x0F12, 0x6402, 0x00, 2},  //70000B74 //TVAR_afit_pBaseValS[472] /AFIT8_YUV422_DENOISE_iYSupport [7:0],   AFIT8_byr_cgras_iShadingPower [15:8]
  ...
  {0x0F12, 0x2CeC, 0x00, 2},  // Patch 23 address (TrapAndPatchOpCodes array index 23)
    // Fillwith alt, 0x00, 2ernative op-codes
  ...
  {0x0F12, 0x00e2, 0x00, 2},  //
    // UpdaP tuning, 0x00, 2 parameters
  {0x002A, 0x337A, 0x00, 2}, 
  {0x0F12, 0x0006, 0x00, 2},  // #Tune_TP_atop_dbus_reg // 6 is the default HW value
    ...
    //=============, 0x00, 2===================================================================================
    //How to set   , 0x00, 2
    //h)ex(CLK you , 0x00, 2want) * 1000)
    //h)ex((CLK you, 0x00, 2 want) * 1000 / 4)
    //h)ex((CLK you, 0x00, 2 want) * 1000 / 4)
    //=============, 0x00, 2==================================================================================
    //Set input CLK, 0x00, 2 // 26MHz
  ...
  {0x0F12, 0x2ee0, 0x00, 2},  //REG_TC_IPRM_OpClk4KHz_0                   	2   700001F6
  ...
  {0x0F12, 0x38A4, 0x00, 2},  //REG_TC_IPRM_OpClk4KHz_2                   	2   70000202
  {0x0F12, 0x4268, 0x00, 2},  //REG_TC_IPRM_MinOutRate4KHz_2              	2   70000204
  {0x0F12, 0x445C, 0x00, 2},  //REG_TC_IPRM_MaxOutRate4KHz_2              	2   70000206
    //Updat        , 0x00, 2
  {0x002A, 0x0208, 0x00, 2}, 
  {0x0F12, 0x0001, 0x00, 2},  // #REG_TC_IPRM_InitParamsUpdated
    //=============, 0x00, 2==========================================
    // Frame settin, 0x00, 2g
    //=============, 0x00, 2==========================================
    // How t       , 0x00, 2
    // 1. Ere value, 0x00, 2
    // dec21 / (fra, 0x00, 2me rate you want(ms))) * 100d * 4d)
    // 2. A Digital, 0x00, 2 gain
    // dec2Analog g, 0x00, 2ain you want) * 256d)
    //=============, 0x00, 2==========================================
    // Set ew expos, 0x00, 2ure time
  ...
  {0x0F12, 0x0000, 0x00, 2}, 
  {0x0F12, 0xD055, 0x00, 2},  // #evt1_lt_uMaxExp4	133ms
  {0x0F12, 0x0000, 0x00, 2}, 
    // Set re expos, 0x00, 2ure time
  ...
  {0x0F12, 0x0197, 0x00, 2},  //01C6 //#REG_0TC_PCFG_usMinFrTimeMsecMult10 //22fps
 ...
 //================, 0x00, 2==========================================================================
 //SET PREVONFIGURA, 0x00, 2TION_1
 //# ForamtV422    , 0x00, 2
 //# Size:         , 0x00, 2
 //# FPS : ps for N, 0x00, 2ight mode
 //================, 0x00, 2==========================================================================
  ...
  {0x0F12, 0x0000, 0x00, 2},  //#REG_1TC_PCFG_uClockInd
  {0x0F12, 0x0000, 0x00, 2},  //#REG_1TC_PCFG_usFrTimeType
  {0x0F12, 0x0001, 0x00, 2}, 
  {0x0F12, 0x07D0, 0x00, 2},  //#REG_1TC_PCFG_usMaxFrTimeMsecMult10 //5fps
  {0x0F12, 0x029A, 0x00, 2},  //#REG_1TC_PCFG_usMinFrTimeMsecMult10 //22fps
  ...
  //===============, 0x00, 2===========================================================================                
  //SET PRECONFIGUR, 0x00, 2ATION_1                                                                                      
  //# ForamUV422   , 0x00, 2                                                                                             
  //# Size:*1536   , 0x00, 2                                                                                                   
  //# FPS :        , 0x00, 2                                                                          
  //===============, 0x00, 2===========================================================================                  
   {0x002A, 0x02CC, 0x00, 2},                                                                                                     
   {0x0F12, 0x0500, 0x00, 2},  //#REG_1TC_PCFG_usWidth//1024                                                                      
   {0x0F12, 0x02D0, 0x00, 2},  //#REG_1TC_PCFG_usHeight //768	 026E                                                              
   {0x0F12, 0x0005, 0x00, 2},  //#REG_1TC_PCFG_Format			0270                                                                   
   {0x0F12, 0x445c, 0x00, 2},  //#REG_1TC_PCFG_usMaxOut4KHzRate  0272                                                             
   {0x0F12, 0x4268, 0x00, 2},  //#REG_1TC_PCFG_usMinOut4KHzRate  0274                                                             
   {0x0F12, 0x0100, 0x00, 2},  //#REG_1TC_PCFG_OutClkPerPix88	0276                                                               
   {0x0F12, 0x0800, 0x00, 2},  //#REG_1TC_PCFG_uMaxBpp88 		027                                                                  
   {0x0F12, 0x0010, 0x00, 2},  //#REG_1TC_PCFG_PVIMask //s0050 = FALSE in MSM6290 : s0052 = TRUE in MSM6800 //reg 027A            
   {0x0F12, 0x0010, 0x00, 2},  //#REG_1TC_PCFG_OIFMask                                                                            
   ...
   {0x0F12, 0x0000, 0x00, 2},  //#REG_1TC_PCFG_usFrTimeType                                                                       
   {0x0F12, 0x0002, 0x00, 2},                                                                                                     
   {0x0F12, 0x029a, 0x00, 2},  //#REG_1TC_PCFG_usMaxFrTimeMsecMult10 //5fps                                                       
   {0x0F12, 0x029a, 0x00, 2}, //#REG_1TC_PCFG_usMinFrTimeMsecMult10 //22fps                                                      
   {0x0F12, 0x0000, 0x00, 2},  //#REG_1TC_PCFG_bSmearOutput                                                                       
   {0x0F12, 0x0000, 0x00, 2},  //#REG_1TC_PCFG_sSaturation                                                                        
   {0x0F12, 0x0000, 0x00, 2},  //#REG_1TC_PCFG_sSharpBlur                                                                         
 ...
 //===============, 0x00, 2===========================================================================                 
  ...
  {0x0F12, 0x0000, 0x00, 2},  //#REG_1TC_PCFG_usFrTimeType                                                             
  {0x0F12, 0x0002, 0x00, 2},                                                                                           
  {0x0F12, 0x03E8, 0x00, 2},  //#REG_1TC_PCFG_usMaxFrTimeMsecMult10 //5fps                                             
  {0x0F12, 0x03E8, 0x00, 2}, //#REG_1TC_PCFG_usMinFrTimeMsecMult10 //22fps                                             
  {0x0F12, 0x0000, 0x00, 2},  //#REG_1TC_PCFG_bSmearOutput                                                             
  {0x0F12, 0x0000, 0x00, 2},  //#REG_1TC_PCFG_sSaturation                                                              
  {0x0F12, 0x0000, 0x00, 2},  //#REG_1TC_PCFG_sSharpBlur                                                               
  {0x0F12, 0x0000, 0x00, 2},  //#REG_1TC_PCFG_sColorTemp                                                               
...
//=================, 0x00, 2=========================================================================
//APPLY PRECONFIGUR, 0x00, 2ATION & RUN PREVIEW
//=================, 0x00, 2=========================================================================
  ...
  {0x0F12, 0x0000, 0x00, 2},  //#REG_0TC_CCFG_uClockInd
  {0x0F12, 0x0000, 0x00, 2},  //#REG_0TC_CCFG_usFrTimeType
  {0x0F12, 0x0002, 0x00, 2}, 
  {0x0F12, 0x07D0, 0x00, 2},  //029A //0535 //#REG_0TC_CCFG_usMaxFrTimeMsecMult10 //7.5fps
  {0x0F12, 0x07D0, 0x00, 2},  //#REG_0TC_CCFG_usMinFrTimeMsecMult10 //10fps
  ...
  {0x0F12, 0x0001, 0x00, 2}, 
  {0x0028, 0x7000, 0x00, 2}, 
  {0xFFFF, 0xC8FF, 0x00, 2},  //p200
};



/*RES_3264x2448 full size*/
const struct _sensor_reg_t s5k5cag_framesize_1280x720[] = {
    {0x0028, 0x7000, 0x00, 2},
    {0x002A, 0x035e, 0x00, 2},                                                                     
    {0x0F12, 0x0800, 0x00, 2},  //#REG_0TC_CCFG_usWidth                                           
    {0x0F12, 0x0480, 0x00, 2},  //0480  //#REG_0TC_CCFG_usHeight                                          
    {0x002a, 0x0246, 0x00, 2},                                                                    
    {0x0f12, 0x0001, 0x00, 2},
    {0x002A, 0x02FC, 0x00, 2}, 
    {0x0F12, 0x0800, 0x00, 2}, 
    {0x0F12, 0x0480, 0x00, 2},
    {0x002A, 0x023E, 0x00, 2}, 
    {0x0F12, 0x0001, 0x00, 2}, 
    ...
    {0x0028, 0x7000, 0x00, 2},                    
    {0x002A, 0x023C, 0x00, 2},                                           
    {0x0F12, 0x0002, 0x00, 2}, //REG_TC_GP_ActivePrevConfig              
    {0x002A, 0x023E, 0x00, 2},                                           
    {0x0F12, 0x0001, 0x00, 2}, //REG_TC_GP_PrevConfigChanged             
    {0xFFFF, 0x64FF, 0x00, 2}, //P100

    //crop                                          
    {0x0028, 0x7000, 0x00, 2},                                        
    {0x002A, 0x0232, 0x00, 2},                                        
    {0x0F12, 0x0800, 0x00, 2},  //REG_TC_GP_ReqInputWidth						  
    {0x0F12, 0x0480, 0x00, 2},  //0600	//REG_TC_GP_ReqInputHeight					  
    {0x0F12, 0x0000, 0x00, 2},  //0000	//REG_TC_GP_InputWidthOfs						  
    {0x0F12, 0x00C0, 0x00, 2}, //0000	//REG_TC_GP_InputHeightOfs            
    {0x0F12, 0x0001, 0x00, 2},  //REG_TC_GP_InputsChangeRequest				
    {0xFFFF, 0x64FF, 0x00, 2}, //P100                                            
...
const struct _sensor_reg_t s5k5cag_framesize_1024x768[] = {
    ...
    {0x002A, 0x0232, 0x00, 2},                                        
    {0x0F12, 0x0800, 0x00, 2},  //REG_TC_GP_ReqInputWidth                         
    {0x0F12, 0x0600, 0x00, 2},  //0600  //REG_TC_GP_ReqInputHeight                    
    {0x0F12, 0x0000, 0x00, 2},  //0000  //REG_TC_GP_InputWidthOfs                         
    {0x0F12, 0x0000, 0x00, 2}, //0000   //REG_TC_GP_InputHeightOfs            
    {0x0F12, 0x0001, 0x00, 2},  //REG_TC_GP_InputsChangeRequest             
    {0xFFFF, 0x64FF, 0x00, 2}, //P100  
    ...
    {0x002A, 0x035e, 0x00, 2},                                                                     
    {0x0F12, 0x0800, 0x00, 2},  //#REG_0TC_CCFG_usWidth                                           
    {0x0F12, 0x0600, 0x00, 2},  //0480  //#REG_0TC_CCFG_usHeight                                          
    {0x002a, 0x0246, 0x00, 2},                                                                    
    {0x0f12, 0x0001, 0x00, 2},  
    {0x002A, 0x02FC, 0x00, 2},
    {0x0F12, 0x0800, 0x00, 2},
...
const struct _sensor_reg_t s5k5cag_framesize_2048x1536[] = {    
    ...
    {0x0028, 0x7000, 0x00, 2},                                                        
    {0x002A, 0x023C, 0x00, 2},                                                        
    {0x0F12, 0x0003, 0x00, 2}, //REG_TC_GP_ActivePrevConfig                           
    {0x002A, 0x023E, 0x00, 2},                                                        
    {0x0F12, 0x0001, 0x00, 2}, //REG_TC_GP_PrevConfigChanged                          
    {0xFFFF, 0x64FF, 0x00, 2},//P100                                                             
