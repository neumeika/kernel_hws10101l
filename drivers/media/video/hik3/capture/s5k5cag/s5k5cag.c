...
#define S5K5CAG_CAM_MODULE_SKIPFRAME     0
...
static framesize_s s5k5cag_framesizes[] = {
    {0, 0, 1024, 768, 1024, 768, 15, 15, 0 , 0, 0x100, VIEW_FULL, RESOLUTION_4_3, true, {s5k5cag_framesize_1024x768, ARRAY_SIZE(s5k5cag_framesize_1024x768)}},
    {0, 0, 1280, 720, 1280, 720, 15, 15, 0 , 0, 0x100, VIEW_FULL, RESOLUTION_16_9, false, {s5k5cag_framesize_1280x720, ARRAY_SIZE(s5k5cag_framesize_1280x720)}},
				 ...
				 struct v4l2_frmsize_discrete *fs, int flag, camera_setting_view_type view_type)
{
	...
	if (state == STATE_PREVIEW) {
      ...
      print_info("enter %s, capture_size is %d", __func__, i);
	return 0;
}
...
static int s5k5cag_set_awb(camera_white_balance awb_mode)
{
	...
	case CAMERA_WHITEBALANCE_INCANDESCENT:
		...
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);		
		s5k5cag_write_reg(0x0F12, 0x08C0, I2C_16BIT, 0x00); //#REG_SF_USER_Bgain 		
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);                                                      
        mdelay(50);
		break;
	...
	case CAMERA_WHITEBALANCE_FLUORESCENT:
		...
		s5k5cag_write_reg(0x002A, 0x04D2, I2C_16BIT, 0x00);     		
		s5k5cag_write_reg(0x0F12, 0x0677, I2C_16BIT, 0x00); // AWB Off      		
		s5k5cag_write_reg(0x002A, 0x04A0, I2C_16BIT, 0x00);  		
		s5k5cag_write_reg(0x0F12, 0x0480, I2C_16BIT, 0x00); //#REG_SF_USER_Rgain   		
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);  		
		s5k5cag_write_reg(0x0F12, 0x0400, I2C_16BIT, 0x00); //REG_SF_USER_Ggain  		
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);  		
		s5k5cag_write_reg(0x0F12, 0x0880, I2C_16BIT, 0x00); //#REG_SF_USER_Bgain 		
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);                            
		mdelay(50);
		break;
	...
	case CAMERA_WHITEBALANCE_DAYLIGHT:
		...
		s5k5cag_write_reg(0x0F12, 0x0677, I2C_16BIT, 0x00); // AWB Off 		
		s5k5cag_write_reg(0x002A, 0x04A0, I2C_16BIT, 0x00); 		
		s5k5cag_write_reg(0x0F12, 0x05A0, I2C_16BIT, 0x00); //#REG_SF_USER_Rgain 	
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00); 		
		s5k5cag_write_reg(0x0F12, 0x0400, I2C_16BIT, 0x00); //REG_SF_USER_Ggain 		
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);		
		s5k5cag_write_reg(0x0F12, 0x0680, I2C_16BIT, 0x00); // #REG_SF_USER_Bgain 		
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);                         
		mdelay(50);
		break;
	...
	case CAMERA_WHITEBALANCE_CLOUDY_DAYLIGHT:
		...
		s5k5cag_write_reg(0x0F12, 0x0480, I2C_16BIT, 0x00); // #REG_SF_USER_Bgain  		
...
static int s5k5cag_set_anti_banding(camera_anti_banding banding)
{	
    print_debug("%s, anti-banding:%#x", __func__, banding);	
    switch (banding) {
        case CAMERA_ANTI_BANDING_AUTO:
            s5k5cag_write_reg(0x0028, 0x7000, I2C_16BIT, 0x00);                                                                                                                       
            s5k5cag_write_reg(0x002A, 0x0C18, I2C_16BIT, 0x00); //#AFC_Default60Hz 
            s5k5cag_write_reg(0x0F12, 0x0000, I2C_16BIT, 0x00); // 1: Auto Flicker 60Hz start 0: Auto Flicker 50Hz start                                                    
            s5k5cag_write_reg(0x002A, 0x04D2, I2C_16BIT, 0x00); //#REG_TC_DBG_AutoAlgEnBits 
            s5k5cag_write_reg(0x0F12, 0x067F, I2C_16BIT, 0x00); 
            msleep(50);
            break;
        ...
        case CAMERA_ANTI_BANDING_50Hz:                                                                                                                       
            s5k5cag_write_reg(0x0028, 0x7000, I2C_16BIT, 0x00);                                                                                                                           
            s5k5cag_write_reg(0x002A, 0x04D2, I2C_16BIT, 0x00);  //#REG_TC_DBG_AutoAlgEnBits 
            s5k5cag_write_reg(0x0F12, 0x065F, I2C_16BIT, 0x00);                                                                                  
            s5k5cag_write_reg(0x002A, 0x04BA, I2C_16BIT, 0x00);  //#REG_SF_USER_FlickerQuant 
            s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);  //  //Flicker 50Hz:0001/60Hz:0002/off:0000                                                          
            s5k5cag_write_reg(0x002A, 0x04BC, I2C_16BIT, 0x00);  //#REG_SF_USER_FlickerQuantChanged 
            s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);  //  //if change 0001 write  
            msleep(50);
            break;
        ...
        case CAMERA_ANTI_BANDING_60Hz:
            ...
            s5k5cag_write_reg(0x0F12, 0x065F, I2C_16BIT, 0x00);                                                                                
            s5k5cag_write_reg(0x002A, 0x04BA, I2C_16BIT, 0x00);  //#REG_SF_USER_FlickerQuant 
            s5k5cag_write_reg(0x0F12, 0x0002, I2C_16BIT, 0x00);  //Flicker 50Hz:0001/60Hz:0002/off:0000                                                          
            s5k5cag_write_reg(0x002A, 0x04BC, I2C_16BIT, 0x00);  //#REG_SF_USER_FlickerQuantChanged 
            s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);  //if change 0001 write
            msleep(50);
            break;
        ...
        case CAMERA_ANTI_BANDING_OFF:
            ...
            s5k5cag_write_reg(0x0F12, 0x065F, I2C_16BIT, 0x00);                                                                                 
            s5k5cag_write_reg(0x002A, 0x04BA, I2C_16BIT, 0x00); //#REG_SF_USER_FlickerQuant 
            s5k5cag_write_reg(0x0F12, 0x0000, I2C_16BIT, 0x00);   //Flicker 50Hz:0001/60Hz:0002/off:0000                                                          
            s5k5cag_write_reg(0x002A, 0x04BC, I2C_16BIT, 0x00); //#REG_SF_USER_FlickerQuantChanged  
            s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);  //if change 0001 write             
            msleep(50);
            break;
...
static int s5k5cag_set_iso(camera_iso iso)
{
	...
	case CAMERA_ISO_100:
		...
		s5k5cag_write_reg(0x002A, 0X04B4, I2C_16BIT, 0x00);		
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);	
		s5k5cag_write_reg(0x002A, 0X0032, I2C_16BIT, 0x00);		
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);
		break;
...
static int s5k5cag_set_ev(int ev)
{
	...
	case -2:
		...
		s5k5cag_write_reg(0x0F12, 0x0018, I2C_16BIT, 0x00);
		mdelay(50);
		break;		
	...
	case -1:
		s5k5cag_write_reg(0x0028, 0x7000, I2C_16BIT, 0x00); 
		s5k5cag_write_reg(0x002A, 0x0F70, I2C_16BIT, 0x00);	//#TVAR_ae_BrAve //ae target
		s5k5cag_write_reg(0x0F12, 0x0040 - 12, I2C_16BIT, 0x00);
		mdelay(50);
		break;		
	...
	case 0:
		s5k5cag_write_reg(0x0028, 0x7000, I2C_16BIT, 0x00); 
		s5k5cag_write_reg(0x002A, 0x0F70, I2C_16BIT, 0x00);	//#TVAR_ae_BrAve //ae target
		s5k5cag_write_reg(0x0F12, 0x0040, I2C_16BIT, 0x00);
		mdelay(50);
		break;		
	...
	case 2:
		s5k5cag_write_reg(0x0028, 0x7000, I2C_16BIT, 0x00); 
		s5k5cag_write_reg(0x002A, 0x0F70, I2C_16BIT, 0x00);	//#TVAR_ae_BrAve //ae target
		s5k5cag_write_reg(0x0F12, 0x0040 + (3 * 12), I2C_16BIT, 0x00);
		mdelay(50);
		break;		
...
static int s5k5cag_init_reg(void)
{
	...
	for(i = 0; i < size; i++) {				
		if (0xFFFF == s5k5cag_sunny_init_regs[i].subaddr) {
			msleep((s5k5cag_sunny_init_regs[i].value & 0xff00) >> 8);
		} else {
...
static int s5k5cag_update_flip(u16 width, u16 height)
{
    ...
    u16 reg = 3; // 180: sensor_flip_value=3;
    u8 new_flip = ((s5k5cag_sensor.vflip << 1) | s5k5cag_sensor.hflip);
    print_debug("enter %s", __func__);
    if (s5k5cag_sensor.old_flip != new_flip) {
        
        if((0 != s5k5cag_sensor.hflip) && (0 == s5k5cag_sensor.vflip)) {
            // HORIZONTAL: sensor_flip_value=1;
            reg = 0x0001;	    
        }else if ((0 != s5k5cag_sensor.vflip)&& (0 == s5k5cag_sensor.hflip)) {
            // Vertical: sensor_flip_value=2;
            reg = 0x0002; 
        } else if((0 != s5k5cag_sensor.vflip) && (0 != s5k5cag_sensor.hflip)) {            
            reg = 0;   
        }
        ...
        s5k5cag_write_reg(0x0028, 0x7000, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x002A, 0x0296, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x0F12,    reg, I2C_16BIT, 0x00);//preview 
		s5k5cag_write_reg(0x0F12,    reg, I2C_16BIT, 0x00);//capture 
		s5k5cag_write_reg(0x002A, 0x02C6, I2C_16BIT, 0x00);          
	    s5k5cag_write_reg(0x0F12,    reg, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x0F12,    reg, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x002A, 0x02F6, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x0F12,    reg, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x0F12,    reg, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x002A, 0x0326, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x0F12,    reg, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x0F12,    reg, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x002A, 0x0356, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x0F12,    reg, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x0F12,    reg, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x002A, 0x023E, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x002A, 0x0246, I2C_16BIT, 0x00);          
		s5k5cag_write_reg(0x0F12, 0x0001, I2C_16BIT, 0x00);   
...
static int s5k5cag_framesize_switch(camera_state state)
{
	...
	for(i = 0; i < size; i++) {				
		if (0xFFFF == s5k5cag_framesizes[next_frmsize_index].sensor_setting.setting[i].subaddr) {
			msleep((s5k5cag_framesizes[next_frmsize_index].sensor_setting.setting[i].value & 0xff00) >> 8);
		} else {
    ...
    s5k5cag_update_flip(s5k5cag_framesizes[next_frmsize_index].width, s5k5cag_framesizes[next_frmsize_index].height);
...
static int s5k5cag_set_saturation(camera_saturation saturation)
{
    ...
    case CAMERA_SATURATION_L2:
	    ...
	    s5k5cag_write_reg(0x0f12, 0xFF81, I2C_16BIT, 0x00); 
        break;
	...
	case CAMERA_SATURATION_H2:
        ...
        s5k5cag_write_reg(0x0028, 0x7000, I2C_16BIT, 0x00);               
        s5k5cag_write_reg(0x002a, 0x0210, I2C_16BIT, 0x00);               
        s5k5cag_write_reg(0x0f12, 0x0078, I2C_16BIT, 0x00);  
        break;     
	default:
...
static int s5k5cag_set_brightness(camera_brightness brightness)
{
    ...
    case CAMERA_BRIGHTNESS_L2:
        ...
        s5k5cag_write_reg(0x0028, 0x7000, I2C_16BIT, 0x00);              
        s5k5cag_write_reg(0x002a, 0x020C, I2C_16BIT, 0x00);                
        s5k5cag_write_reg(0x0f12, 0xFFB0, I2C_16BIT, 0x00);     
        break;
	...
	case CAMERA_BRIGHTNESS_H2:
        ...
        s5k5cag_write_reg(0x0028, 0x7000, I2C_16BIT, 0x00);              
        s5k5cag_write_reg(0x002a, 0x020C, I2C_16BIT, 0x00);              
        s5k5cag_write_reg(0x0f12, 0x0050, I2C_16BIT, 0x00); 
        break;     
	default:
...
static void s5k5cag_set_default(void)
{
	...
	strcpy(s5k5cag_sensor.info.name,"s5k5cag");//s5k5cag_sensor.name = "s5k5cag";
	...
	s5k5cag_sensor.skip_frames = S5K5CAG_CAM_MODULE_SKIPFRAME;
	...
	s5k5cag_sensor.set_anti_banding = NULL;
	...
	s5k5cag_sensor.sensor_tune_ops->set_anti_banding = s5k5cag_set_anti_banding;
}
