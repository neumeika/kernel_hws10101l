...
static int tps61310_turn_on_test(work_mode mode, flash_lum_level lum,int flag)
{
	u8 val;
	print_debug("enter %s", __FUNCTION__);
...
static ssize_t flash_debug_store(struct kobject *kobj, struct kobj_attribute *attr, const char *buf, size_t count)
{
    ...
    case 0x11:
        tps61310_init();
        tps61310_turn_on_test(TORCH_MODE, 0,1);
        //msleep(500);
        //tps61310_turn_off();
        break;
    //enable led3
    case 0x22:
        tps61310_init();
        tps61310_turn_on_test(TORCH_MODE, 0,2);
        //msleep(500);
        //tps61310_turn_off();
        break;
	case 0x00:
    ...
    default:
        print_error("Your input is wrong!\n");
	break;
    }
    return count;    //return 2; for echo test.
}
//end:modified by hushaowu 2012.03.19
