...
extern int panasonic_pwm_on(struct k3_fb_data_type *k3fd);
extern int panasonic_pwm_off(struct k3_fb_data_type *k3fd);
struct platform_device *pdev_lcd = NULL;
#elif defined(CONFIG_LCD_QIMEI_HJ101IA_01F_10)
extern int qimei_pwm_on(struct k3_fb_data_type *k3fd);
extern int qimei_pwm_off(struct k3_fb_data_type *k3fd);
struct platform_device *pdev_lcd = NULL;
#endif
...
//keep this at the end of function
#ifdef CONFIG_LCD_PANASONIC_VVX10F002A00
        msleep(50);
...
extern struct k3_fb_data_type *k3fd_hdmi;
