...
static int pl031_probe(struct amba_device *adev, const struct amba_id *id)
{
    ...
    char * version_date = init_uts_ns.name.version;
...

	{
		...
		/* PMU RTC not set */
		if (rtccr_val == 0) {
            if (NULL != strstr(version_date , "2013"))
                tm.tm_year = 113;
            else if (NULL != strstr(version_date , "2014"))
                tm.tm_year = 114;
            else if (NULL != strstr(version_date , "2015"))
                tm.tm_year = 115;
            else if (NULL != strstr(version_date , "2016"))
                tm.tm_year = 116;
            else if (NULL != strstr(version_date , "2017"))
                tm.tm_year = 117;
            else
                tm.tm_year = 113;
            
            if (NULL != strstr(version_date , "Jan"))
                tm.tm_mon = 0;
            else if (NULL != strstr(version_date , "Feb"))
                tm.tm_mon = 1;
            else if (NULL != strstr(version_date , "Mar"))
                tm.tm_mon = 2;
            else if (NULL != strstr(version_date , "Apr"))
                tm.tm_mon = 3;
            else if (NULL != strstr(version_date , "May"))
                tm.tm_mon = 4;
            else if (NULL != strstr(version_date , "Jun"))
                tm.tm_mon = 5;
            else if (NULL != strstr(version_date , "Jul"))
                tm.tm_mon = 6;
            else if (NULL != strstr(version_date , "Aug"))
                tm.tm_mon = 7;
            else if (NULL != strstr(version_date , "Sep"))
                tm.tm_mon = 8;
            else if (NULL != strstr(version_date , "Oct"))
                tm.tm_mon = 9;
            else if (NULL != strstr(version_date , "Nov"))
                tm.tm_mon = 10;
            else if (NULL != strstr(version_date , "Dec"))
                tm.tm_mon = 11;
            else
                tm.tm_mon = 0;
