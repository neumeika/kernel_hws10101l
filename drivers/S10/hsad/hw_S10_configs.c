...
config_pair  hw_S10_configs [] = {
    ...
    {"product/name", (const unsigned int)(unsigned int*)"S10", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_S10= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_S10,
	.data_array={.config_pair_ptr=hw_S10_configs},
	.list={NULL,NULL},
};
