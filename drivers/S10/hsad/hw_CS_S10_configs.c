...
config_pair  hw_CS_S10_configs [] = {
    ...
    {"board/board_type", (unsigned int)8, E_CONFIG_DATA_TYPE_INT },
    ...
    {"lcd/lcd_type", (unsigned int)8, E_CONFIG_DATA_TYPE_INT },
    {"product/name", (const unsigned int)(unsigned int*)"CS_S10", E_CONFIG_DATA_TYPE_STRING },
...
struct board_id_general_struct config_common_CS_S10= {
	.name=COMMON_MODULE_NAME,
	.board_id=BOARD_ID_CS_S10,
	.data_array={.config_pair_ptr=hw_CS_S10_configs},
	.list={NULL,NULL},
};
